...
-- Migration: 20260919183000_strict_cashier_validation.sql
-- 1. Strictly reject invalid explicit cashier in create_invoice_atomic without fallback
-- 2. Strictly reject invalid explicit cashier in collect_payment_atomic without fallback
-- =====================================================================================

-- -------------------------------------------------------------------------------------
-- 1. HARDEN create_invoice_atomic (Zero-Fallback Explicit Cashier Validation)
-- -------------------------------------------------------------------------------------
...
BEGIN
    ...
    IF v_paid > 0 THEN
        ...
        -- Authoritative cashier validation: strictly reject invalid explicit cashier without fallback
...
-- -------------------------------------------------------------------------------------
-- 2. HARDEN collect_payment_atomic (Zero-Fallback Explicit Cashier Validation)
-- -------------------------------------------------------------------------------------
