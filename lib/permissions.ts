...
export const PERMISSIONS = {
  ...
  // Arch Enterprise Extensions (Conversation 35: Modules 11-34)
  REFERRAL_VIEW: "referral.view",
  REFERRAL_MANAGE: "referral.manage",
  LIS_ADAPTER_VIEW: "lis_adapter.view",
  LIS_ADAPTER_MANAGE: "lis_adapter.manage",
  FEEDBACK_VIEW: "feedback.view",
  FEEDBACK_MANAGE: "feedback.manage",
  SCHOLARSHIP_VIEW: "scholarship.view",
  SCHOLARSHIP_MANAGE: "scholarship.manage",
  LAB_TO_LAB_VIEW: "lab_to_lab.view",
  LAB_TO_LAB_MANAGE: "lab_to_lab.manage",
  RECRUITMENT_VIEW: "recruitment.view",
  RECRUITMENT_MANAGE: "recruitment.manage",
  OVERSEAS_MEDICAL_VIEW: "overseas_medical.view",
  OVERSEAS_MEDICAL_MANAGE: "overseas_medical.manage",
  ...
  ACCREDITATION_VIEW: "accreditation.view",
  ACCREDITATION_MANAGE: "accreditation.manage",
  PARTY_LEDGER_VIEW: "party_ledger.view",
  PARTY_LEDGER_MANAGE: "party_ledger.manage",
  DAYCARE_VIEW: "daycare.view",
  DAYCARE_MANAGE: "daycare.manage",
